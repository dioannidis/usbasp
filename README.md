...
- From version 1.09 a ( reliable at 9600 Baud, with 120ms - 160ms intervals for higher ) UART HID implementation is added for debugging purposes. USBasp will appear as a composite device with a WINUSB interface and a HID interface.
